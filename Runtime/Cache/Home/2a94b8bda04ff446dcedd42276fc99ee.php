...
<html lang="zh-CN">
	...
	<link rel="stylesheet" type="text/css" href="/asdf/Public/Home/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="/asdf/Public/Home/css/nprogress.css">
	<link rel="stylesheet" type="text/css" href="/asdf/Public/Home/css/style.css">
	<link rel="stylesheet" type="text/css" href="/asdf/Public/Home/css/font-awesome.min.css">
	<link rel="apple-touch-icon-precomposed" href="images/icon/icon.png">
	<link rel="shortcut icon" href="/asdf/Public/Home/images/icon/favicon.ico">
	<script src="/asdf/Public/Home/js/jquery-2.1.4.min.js"></script>
	<script src="/asdf/Public/Home/js/nprogress.js"></script>
	<script src="/asdf/Public/Home/js/jquery.lazyload.min.js"></script>
	<script src="/asdf/Public/Home/js/bootstrap.min.js"></script> 
	<!--[if gte IE 9]>
	  ...
	  <nav class="navbar navbar-default" id="navbar">
		<div class="container">
		  ...
		  <div class="navbar-header">
			...
			<h1 class="logo hvr-bounce-in"><a href="" title=""><img src="/asdf/Upload/config/<?php echo C('web_logo');?>" alt="" style="width:160px;height:60px;"></a></h1>
		  </div>
    ...
    <div class="content">
      ...
      <div id="focusslide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active"> <a href="" target="_blank"><img src="/asdf/Public/Home/images/banner/banner_01.jpg" alt="" class="img-responsive"></a> 
            <!--<div class="carousel-caption"> </div>--> 
          </div>
          <div class="item"> <a href="" target="_blank"><img src="/asdf/Public/Home/images/banner/banner_02.jpg" alt="" class="img-responsive"></a> 
            <!--<div class="carousel-caption"> </div>--> 
          </div>
          <div class="item"> <a href="" target="_blank"><img src="/asdf/Public/Home/images/banner/banner_03.jpg" alt="" class="img-responsive"></a> 
            <!--<div class="carousel-caption"> </div>--> 
          </div>
        </div>
      ...
      <article class="excerpt excerpt-1"><a class="focus" href="article.html" title=""><img class="thumb" data-original="/asdf/Public/Home/images/excerpt.jpg" src="/asdf/Public/Home/images/excerpt.jpg" alt=""></a>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="/asdf/Public/Home/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--该功能正在日以继夜的开发中-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="/asdf/Public/Home/images/baoman/baoman_01.gif" alt="深思熟虑" />
...
<div id="rightClickMenu">
  <ul class="list-group rightClickMenuList">
	...
	<script src="/asdf/Public/Home/js/jquery.ias.js"></script> 
	<script src="/asdf/Public/Home/js/scripts.js"></script>
</body>
</html>