		...
		<div id="main" class="main">
			<div class="portlet box blue">
				...
				<div class="portlet-body form">
					<form action="<?php echo U('Config/configEdit');?>" class="form-horizontal" method="POST" id="from" enctype="multipart/form-data">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="web_keywords"  class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;便于搜索引擎进行搜索."  />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">网站描述：</label>
							<div class="controls">
								<input type="text" name="web_description" value="<?php echo ($data["web_description"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;对网站的一些简单介绍."  />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">备案号：</label>
							<div class="controls">
								<input type="email" name="web_icp" value="<?php echo ($data["web_icp"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;便于工信部进行查询."  />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">网站状态：</label>
							<div class="controls">
								<select name="web_close" class="chosen-with-diselect span6 m-wrap popovers"  data-trigger="hover" data-content="*&nbsp;不同的状态值代表不同的操作." >
						...
						<div class="form-actions">
							<button type="submit" id="submit" class="btn blue  submit-btn ajax-post" target-form="form-horizontal">确认</button>
