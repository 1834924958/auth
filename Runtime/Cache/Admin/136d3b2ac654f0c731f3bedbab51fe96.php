		...
		<div id="main" class="main">
			<div class="portlet box blue">
				<div class="portlet-title">
					<a href="<?php echo U('Article/articles');?>" style="color:white;">
						<div class="caption"><i class="icon-reorder"></i>文章管理</div>
					</a>
					<div class="caption">
						<?php if(empty($data)): ?>&nbsp;&nbsp;文章添加
						<?php else: ?>
							&nbsp;&nbsp;文章编辑<?php endif; ?>
					</div>
					<div class="tools">
				...
				<div class="portlet-body form">
					<form action="<?php echo U('Article/articlesEdit');?>" method ="POST" id="form" class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="type" class="span6  m-wrap popovers" data-placeholder="Choose a Category" data-trigger="hover" data-content="*&nbsp;不同的分类代表不同的上级.">
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($data["type"]) == $key): ?>selected<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="title" value="<?php echo ($data["title"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;文章的标题一般显示在前台中."/>
							</div>
						</div>
						<div class="control-group">
