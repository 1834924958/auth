		...
		<div id="main" class="main">
			<div class="portlet box light-grey">
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="<?php echo U('Article/adverEdit');?>">
						...
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post btn-warning" url="<?php echo U('Article/adverStatus',array('type'=>'forbid'));?>" target-form="ids">
							禁用&nbsp;<i class="icon-lock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn green ajax-post btn-info" url="<?php echo U('Article/adverStatus',array('type'=>'resume'));?>" target-form="ids">
							启用&nbsp;<i class="icon-unlock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post confirm btn-danger" url="<?php echo U('Article/adverStatus',array('type'=>'del'));?>" target-form="ids">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
								...
								<td><a href="#" style="text-decoration:none;"><?php echo ($vo["url"]); ?></a></td>
								<td class="hidden-480"><img src="/Upload/adver/<?php echo ($vo["img"]); ?>" style="height:20px;"/></td>
								<td><?php echo (addtime($vo["addtime"])); ?></td>
								<td><?php echo (addtime($vo["endtime"])); ?></td>
								<td><?php echo ($vo["sort"]); ?></td>
								<td class="center hidden-480">
									<?php if(($vo["status"]) == "0"): ?><span class="label label-inverse">禁用</span><?php endif; ?>
									<?php if(($vo["status"]) == "1"): ?><span class="label label-success">启用</span><?php endif; ?>
								</td>
