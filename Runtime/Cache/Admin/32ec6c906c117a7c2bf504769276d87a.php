...
<head>
    ...
    <link href="/asdf/Public/Admin/images/as.jpg" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/asdf/Public/Admin/css/login.css" media="all">
    <link rel="stylesheet" type="text/css" href="/asdf/Public/Admin/css/default_color.css" media="all">
</head>
<body id="login-page">
<div id="main-content">
...
<script type="text/javascript">
    ...
    var bg = 'url(/asdf/Public/Admin/images/bg_' + random_bg + '.jpg)';
