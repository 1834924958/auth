		...
		<div id="main" class="main">
			<div class="portlet box blue">
				<div class="portlet-title">
					<a href="<?php echo U('Admin/Menu/menu');?>" style="color:white;">
						<div class="caption"><i class="icon-reorder"></i>菜单列表</div>
					</a>
					<div class="caption">
						<?php if(empty($data)): ?>&nbsp;&nbsp;菜单添加
						<?php else: ?>
							&nbsp;&nbsp;菜单编辑<?php endif; ?>
					</div>
					<div class="tools">
				...
				<div class="portlet-body form">
					<form action="<?php echo U('Admin/Menu/menuEdit');?>" method ="POST" id="form" class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="title" value="<?php echo ($data["title"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;菜单名要符合规则."/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">URL链接：</label>
							<div class="controls">
								<input type="text" name="url" value="<?php echo ($data["url"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;输入模块/控制器/方法即可,例如:Admin/Ches/index."/>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="ico_name" value="<?php echo ($data["ico_name"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;菜单的图标要符合规则."/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">菜单排序：</label>
							<div class="controls">
								<input type="text" name="sort" value="<?php echo ($data["sort"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;菜单的排序按照正序排序(正数)."/>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="hide" class="span6  m-wrap popovers" data-placeholder="Choose a Category" data-trigger="hover" data-content="*&nbsp;不同的状态值代表不同的操作.">
									<option value="1" <?php if(($data["hide"]) == "1"): ?>selected<?php endif; ?>>隐藏</option>
									<option value="0" <?php if(($data["hide"]) == "0"): ?>selected<?php endif; ?>>不隐藏</option>
								</select>
							</div>
						</div>
