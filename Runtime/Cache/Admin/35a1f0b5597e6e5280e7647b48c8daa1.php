		...
		<div id="main" class="main">
			<div class="portlet box light-grey">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-globe"></i>菜单列表(*&nbsp;本节点可以实现无线级分类，但此系统用的三级级联,所以分三级节点,比较完美.若想实现更多级节点,请变更多级联.)
					</div>
					<div class="tools">
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="<?php echo U('Admin/Menu/menuEdit');?>">
						...
						<div class="btn-group">
							<a href="#">
								<button id="sample_editable_1_new" class="btn gray">
									全部节点:&nbsp;&nbsp;<b><?php echo ($count); ?></b>&nbsp;条,&nbsp;&nbsp;&nbsp;
									顶级节点:&nbsp;&nbsp;<b><?php echo ($dj); ?></b>&nbsp;条,&nbsp;&nbsp;&nbsp;
									其他节点:&nbsp;&nbsp;<b><?php echo ($qt); ?></b>&nbsp;条,&nbsp;&nbsp;&nbsp;
								</button>
							</a>
						</div>
					</div>
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
									...
									<td>
										<a href="#" style="text-decoration:none;"><?php echo ($vo["url"]); ?></a>
									</td>
									<td><?php echo (addtime($vo["addtime"])); ?></td>
									<td >
										<?php if(($vo["hide"]) == "0"): ?><span class="label label-success"><i class="icon-unlock"></i>&nbsp;不隐藏</span><?php endif; ?>
										<?php if(($vo["hide"]) == "1"): ?><span class="label label-danger"><i class="icon-lock"></i>&nbsp;隐藏</span><?php endif; ?>
									</td>
									<td >

										<a href="<?php echo U('Admin/Menu/menuEdit?id='.$vo['id']);?>" class="btn mini purple"><i class="icon-edit"></i>&nbsp;编辑</a>
										<a href="<?php echo U('Admin/Menu/msubsetEdit?sid='.$vo['id']);?>" class="btn mini blue"><i class="icon-plus"></i>&nbsp;添加子菜单</a>
										<a href="<?php echo U('Admin/Menu/menuDete?id='.$vo['id']);?>" class="btn mini red"><i class="icon-trash"></i>&nbsp;删除</a>
									</td>
