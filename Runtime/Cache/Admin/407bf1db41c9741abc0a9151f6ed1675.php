		...
		<div id="main" class="main">
			<div class="portlet box blue">
				<div class="portlet-title">
					<a href="<?php echo U('Article/articleType');?>" style="color:white;">
						<div class="caption"><i class="icon-reorder"></i>文章类型管理</div>
					</a>
					<div class="caption">
						<?php if(empty($data)): ?>&nbsp;&nbsp;文章类型添加
						<?php else: ?>
							&nbsp;&nbsp;文章类型编辑<?php endif; ?>
					</div>
					<div class="tools">
				...
				<div class="portlet-body form">
					<form action="<?php echo U('Article/articleTypeEdit');?>" method ="POST" id="form" class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name" value="<?php echo ($data["name"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;文章类型的简写，便于索引."/>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<select name="shang" class="span6  m-wrap popovers" data-placeholder="Choose a Category" data-trigger="hover" data-content="*&nbsp;默认不选为顶级分类.">
									<option value="" <?php if(($data["shang"]) == ""): ?>selected<?php endif; ?>>顶级分类</option>
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($data["shang"]) == $key): ?>selected<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="title" value="<?php echo ($data["title"]); ?>" class="span6 m-wrap popovers" data-trigger="hover" data-content="*&nbsp;文章的标题."/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">文章内容：</label>
							<div class="controls">
								<script id="content" type="text/plain" name="content"><?php echo ($data["content"]); ?></script>
							</div>
						</div>
						<div class="control-group">
