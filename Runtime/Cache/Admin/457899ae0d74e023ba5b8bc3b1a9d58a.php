		...
		<div id="main" class="main">
			<div class="portlet box light-grey">
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post confirm btn-danger" url="<?php echo U('Admin/User/AdminLogStatus',array('type'=>'del'));?>" target-form="ids">
						...
						<div class="btn-group pull-right">
							<form name="formSearch" id="formSearch" method="get" class="btn-group pull-right">
								<div class="btn-group pull-right" id="sample_1_filter">
									...
									<a href="<?php echo U('Admin/User/AdminLog');?>">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
										...
										<td><?php echo ($vo["uid"]); ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php echo ($vo["title"]); ?></td>
										<td>
											<a href="#" style="text-decoration:none;"><?php echo ($vo["loginip"]); ?></a>
										</td>
										<td class="hidden-480"><?php echo (addtime($vo["logintime"])); ?></td>
										<td >
											<?php if(($vo["status"]) == "0"): ?><span class="label label-danger"><i class="icon-lock"></i>&nbsp;异常</span><?php endif; ?>
											<?php if(($vo["status"]) == "1"): ?><span class="label label-success"><i class="icon-unlock"></i>&nbsp;正常</span><?php endif; ?>
										</td>
