		...
		<div id="main" class="main">
			<div class="portlet box light-grey">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-globe"></i>权限列表(*本节点可以实现无限极分类,本系统适合3~4级.)
					</div>
					<div class="tools">
				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							<a href="<?php echo U('Admin/Menu/AuthEdit');?>">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
									...
									<td>
										<a href="#" style="text-decoration:none;"><?php echo ($vo["name"]); ?></a>
									</td>
									<td><?php echo (addtime($vo["addtime"])); ?></td>
									<td >
										<a href="<?php echo U('Admin/Menu/AuthEdit?id='.$vo['id']);?>" class="btn mini purple"><i class="icon-edit"></i>&nbsp;编辑</a>
										<a href="<?php echo U('Admin/Menu/AuthsEdit?sid='.$vo['id']);?>" class="btn mini blue"><i class="icon-plus"></i>&nbsp;添加子权限</a>
										<a href="<?php echo U('Admin/Menu/AuthDelete?id='.$vo['id']);?>" class="btn mini red"><i class="icon-trash"></i>&nbsp;删除</a>
									</td>
